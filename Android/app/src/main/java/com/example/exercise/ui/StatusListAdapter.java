...
import com.example.exercise.ui.base.BaseListAdapter;
import com.example.exercise.ui.base.ViewHolder;
...
public class StatusListAdapter extends BaseListAdapter<Status> {
  ...
  public View getView(int position, View conView, ViewGroup parent) {
    if (conView == null) {
      conView = inflater.inflate(com.example.exercise.R.layout.status_item, null, false);
    }
